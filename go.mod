...
require (
	...
	github.com/riverqueue/river v0.41.1 // indirect
...
replace github.com/openshift-hyperfleet/hyperfleet-broker => github.com/ciaranRoche/hyperfleet-broker v0.0.0-20260730070917-2efa7deb2e47
